...
def newpost(request):
    ...
    if request.method == "POST": # после отправки формы
        ...
        if bblogform.is_valid(): #валидация полей формы
        ...
        blogform = BlogForm() # создание объекта формы для ввода данных нового пользователя
