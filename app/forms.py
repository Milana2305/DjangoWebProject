...
class AnketaForm(forms.Form):
    ...
    notice = forms.BooleanField(label='Получать новости сайта на е-mail?',
                                required=False)
...
class BlogForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'tatle': "Заголовок", 'description': "Краткое содержание", 'content': "Полное содержание", 'image': "Картинка"}
